...
Improve the parsing throughput (ops/sec) of the mri CLI argument parser by at least 1% while maintaining functional correctness. The baseline benchmark parses arguments like `-b --bool --no-meep --multi=baz` and measures operations per second.

## What you CAN modify

- `src/index.js` — CLI argument parser source code
